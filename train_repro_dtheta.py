...
from models.tokenAdaptive_guided import *
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dtheta', default=0.0, type=float)
    ...
    train_loader = DataLoader(train_dataset, num_workers=args.num_workers, batch_size=args.batch_size, shuffle=False,
                              sampler=sampler, drop_last=True, pin_memory=True, collate_fn=train_collate_fn)
    test_loader_unlabelled = DataLoader(unlabelled_train_examples_test, num_workers=args.num_workers,
                                        batch_size=256, shuffle=False, pin_memory=False, collate_fn=eval_collate_fn)
    ...
    # PROJECTION HEAD
    # ----------------------
    backbone_modify = TokenAdaptivePrunerGuided(args, backbone)
