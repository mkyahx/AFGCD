#!/bin/bash
#SBATCH --job-name=simgcd_cub_alpha
...
#SBATCH --output=/userhome/cs/mkyahx/dev_outputs/submit_cub_repro_alpha_%j.out
#SBATCH --error=/userhome/cs/mkyahx/dev_outputs/submit_cub_repro_alpha_%j.err
