#!/bin/bash
#SBATCH --job-name=simgcd_air_alpha
...
#SBATCH --output=/userhome/cs/mkyahx/dev_outputs/submit_aircraft_repro_alpha_%j.out
#SBATCH --error=/userhome/cs/mkyahx/dev_outputs/submit_aircraft_repro_alpha_%j.err
...
for seed in 0 1; do
    CUDA_VISIBLE_DEVICES=0 python train_repro_alpha.py \
        ...
        --alpha "$ALPHA" \
        --seed $seed \
        --exp_name aircraft_simgcd_alpha_${ALPHA}_seed_${seed}
done
