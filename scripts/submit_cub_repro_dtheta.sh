#!/bin/bash
#SBATCH --job-name=simgcd_cub_dtheta
...
#SBATCH --output=/userhome/cs/mkyahx/dev_outputs/submit_cub_repro_dtheta_%j.out
#SBATCH --error=/userhome/cs/mkyahx/dev_outputs/submit_cub_repro_dtheta_%j.err
...
for seed in 0; do
    CUDA_VISIBLE_DEVICES=0 python train_repro_dtheta.py \
        ...
        --dtheta "$DTHETA" \
        --seed $seed \
        --exp_name cub_simgcd_dtheta_${DTHETA}_seed_${seed}
done
