#!/bin/bash
#SBATCH --job-name=simgcd_cars_repro
...
#SBATCH --output=/userhome/cs/mkyahx/dev_outputs/AF_cars_repro_%j.out
#SBATCH --error=/userhome/cs/mkyahx/dev_outputs/AF_cars_repro_%j.err
